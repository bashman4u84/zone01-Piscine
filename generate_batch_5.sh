...
# All backticks within the template literals are now double-escaped (\\`)
# to ensure they are correctly interpreted by the Node.js runtime.
cat << 'EOF' > create_doc_batch_5.js
...
chmod +x create_doc_batch_5.js
node create_doc_batch_5.js